...
def processar_pagamento_mock(pagamento: schemas.PagamentoMock, db: Session = Depends(get_db)):
    ...
    # 1. Procuramos a comanda do cliente no banco
    ...
    # 2. Criamos o comprovante de pagamento APROVADO
    ...
    # 3. REGRA DE NEGÓCIO: Mudamos o status do Pedido para a cozinha começar a fazer!
